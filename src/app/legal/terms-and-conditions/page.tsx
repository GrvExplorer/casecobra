    ...
    <div className="h-[75vh]">
      ...
      <p className="mt-10">
        ...
        <p className="mt-4">
          ...
          page shall mean Gaurav Verma , whose registered/operational office is
          Pandri Raipur CHATTISGARH 492004 . &quot;you&quot;, &quot;your&quot;,
          &quot;user&quot;, “visitor” shall mean any natural or legal person who
        ...
        <ul className="mt-4 list-disc flex flex-col gap-4">
          <li>
          ...
          <li>
            ...
            document without Gaurav Verma ’s prior written consent.
          </li>
        </ul>
      </p>
    </div>
