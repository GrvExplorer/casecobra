      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={global.defaultPadding}>
            <Text style={adressTitle}>Shipping to: {"Gaurav Verma"}</Text>
            <Text style={{ ...global.text, fontSize: 14 }}>
              {"Pandri"}, {"Raipur"}, {"Chattisgarh"} {492009}
            </Text>
          </Section>
          <Hr style={global.hr} />
          <Section style={global.defaultPadding}>
            <Row style={{ display: "inline-flex gap-16", marginBottom: 40 }}>
              ...
              <Column style={{ marginLeft: 20 }}>
                ...
                <Text style={track.number}>{new Date(orderDate).toLocaleDateString()}</Text>
              </Column>
            </Row>
          </Section>
